...
% KALMAN FILTER
%--------------------------------------------------------------------------
function [xrealT, VrealT,xsmooth, Vsmooth, VVsmooth, loglik] = runKFandKS(y, T, Z, Q, R, x_0, Sig_0);
% function [xsmooth, Vsmooth, VVsmooth, loglik] = runKF(y, A, C, Q, R, x_0, Sig_0);

S = SKF(y,Z,R,T,Q, x_0, Sig_0);
S = FIS(y,Z,R,T,Q,S);
