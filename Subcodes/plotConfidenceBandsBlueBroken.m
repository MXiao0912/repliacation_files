function [] = plotConfidenceBandsBlueBroken(x,percentiles,colour)
...
%         boundedlineBlue(x, percentiles(:,numberOfBands+1), [lowerbound, upperbound],colour,colourBand,'alpha');
        boundedlineBlueBroken(x, percentiles(:,numberOfBands+1), [lowerbound, upperbound],colour,colourBand);

        else
        boundedlineBlueBroken(x, percentiles(:,numberOfBands+1), [lowerbound, upperbound],colour,'alpha');
